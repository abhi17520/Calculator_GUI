...
class Calculator:
    def __init__(self):
        ...
        self.lblDisplay = Label(self.root,width=24,height=2,bg='White')
        ...
        btnSubtract = Button(self.root, width=5, height=2, bg='SkyBlue', text="-",
        ...
        btn0 = Button(self.root, width=5, height=2, bg='SkyBlue', text="0",
                             command=lambda: self.getOpt("0")).grid(row=4, column=1)
